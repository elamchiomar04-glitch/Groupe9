...
def _(mo):
    ...
    - L'axe $x$ représente l'**horizontale** et est dirigé vers le haut.
    - L'axe $y$ représente la **verticale** et est dirigé vers la gauche.
    ...
    - Composante verticale : $f_x = f \sin(\theta + \phi)$
    - Composante horizontale : $f_y = f \cos(\theta + \phi)$
    """)
    return
